...
function PlayScene() {
    ...
    function hitObstacle(player, obstacle) {
        ...
        sendMessageToParent('GAME_OVER', { score: score });
...
function GameOverScene() {
    ...
    this.scene.create = function() {
        ...
        this.add.text(400, 380, 'Click outside to claim rewards in the app!', {
            fontSize: '20px',
            fill: '#ffffff',
            stroke: '#000',
            strokeThickness: 3
        ...
        // PLAY AGAIN BUTTON
        // ========================================
        const playButton = this.add.rectangle(400, 460, 300, 60, 0x4169E1);
        const playText = this.add.text(400, 460, 'Play Again', {
            fontSize: '28px',
            fill: '#fff',
            fontStyle: 'bold'
        }).setOrigin(0.5);
